...
dataset_names = ["MBZUAI/ArVoice", "MBZUAI/ClArTTS", "MBZUAI/TunSwitch", "MBZUAI/mdaspc", "MBZUAI/Mixat", "MBZUAI/ArzEn"]
dataset_names = ["MBZUAI/ClArTTS", "MBZUAI/TunSwitch", "MBZUAI/mdaspc"]
test_splits = ["test", "validation", "test"]
...
for i, dataset_name in enumerate(dataset_names):
    ...
    for split in splits:
        ...
        for i, item in tqdm(enumerate(ds[split])):
            ...
            relative_audio_path = os.path.join(split, "audios", audio_filename)
